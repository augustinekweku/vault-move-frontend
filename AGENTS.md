...
| `PortalLayout` (landlord/agent/developer side menu) | dashboard, dashboard/listings, dashboard/listings/:propertyId/preview, dashboard/create-listing, dashboard/enquiries |
