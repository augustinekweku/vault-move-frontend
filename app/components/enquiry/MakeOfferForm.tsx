  ...
  return (
    <label className="flex flex-col gap-1.5">
      ...
      <span className="relative block">
        <input
          className={cn(
            "h-10.75 w-full rounded-lg border border-line bg-white px-3.5 text-[15.5px] leading-6 text-ink shadow-[0_1px_2px_rgba(16,24,40,0.05)] placeholder:text-muted-500 focus:border-brand focus:outline-none",
            suffix && "pr-12",
          )}
          {...props}
        />
