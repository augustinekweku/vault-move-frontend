  ...
  return (
    <section className="relative overflow-x-clip bg-surface">
      ...
      <div className="hidden lg:block">
        <div className="relative mx-auto h-[772px] max-w-[1440px]">
          <h1 className="absolute left-20 top-[140px] z-10 w-[628px] text-[54px] font-bold leading-[72px] text-brand">
            Find, Offer, and Secure Your Next Property,
            <br />
            <span className="text-accent">All in One Place!</span>
          </h1>

          <p className="absolute left-20 top-[392px] z-10 w-[457px] text-lg leading-8 text-ink-muted">
          ...
          <div className="absolute left-20 top-[530px] z-20 w-[min(1277px,calc(100%_-_160px))]">
            <PropertySearchBar />
          </div>
          ...
          <img
            ...
            alt="Modern property"
            className="absolute left-[732px] top-0 z-0 h-[772px] w-[min(708px,calc(100%_-_732px))] rounded-l-[60px] object-cover"
          />
        </div>
      </div>
      ...
      <div className="lg:hidden">
        ...
        <div className="px-6 py-12 sm:px-10">
          <h1 className="max-w-[628px] text-4xl font-bold leading-tight text-brand sm:text-5xl">
            Find, Offer, and Secure Your Next Property,{" "}
            <span className="text-accent">All in One Place!</span>
          </h1>
