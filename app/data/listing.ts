 ...
 *  is live. */
const OFFER_BID_AVATAR =
  "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80";

const OFFER_BID_NOTE = "I will be hosting events in my apartments.";
...
export const MOCK_OFFER_BIDS: OfferBid[] = [
  {
    ...
    initials: "JD",
    avatar: OFFER_BID_AVATAR,
    amountLabel: "3500 ghc/mo",
    amountDetail: "3500 GHC / month",
    moveInDate: "March 2027",
    moveInFull: "1st March 2027",
    stayDuration: "1 year",
    stayFull: "1 year",
    note: OFFER_BID_NOTE,
    verified: true,
